...
if not os.path.exists('dataResult/scores_LOD_smooth_lag3.npy'):
...
if not os.path.exists('dataResult/scores_LA_smooth_lag3.npy'):
...
if not os.path.exists('dataResult/scores_RD_smooth_lag3.npy'):
...
if not os.path.exists('dataResult/scores_LR_smooth_lag3.npy'):
...
if not os.path.exists('dataResult/scores_ML_smooth_lag3.npy'):
...
plt.savefig('smooth-spatial-lag3.png', bbox_inches='tight', dpi=180)
